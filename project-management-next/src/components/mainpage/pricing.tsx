        ...
        <div key={index} className="w-full relative flex flex-col saturate-150 rounded-2xl">
            ...
            <div
                className={cn(
                    ...
                    id === "pro" ? "border-blue-400" : "border-border/60",
                )}
            >
                {id === "pro" && (
                    <div className="max-w-fit min-w-min inline-flex items-center whitespace-nowrap px-1 h-7 rounded-full bg-gradient-to-r from-purple-700 to-blue-400 absolute -top-3 left-1/2 -translate-x-1/2 select-none">
